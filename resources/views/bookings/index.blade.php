                  ...
                  <form class="main_form" autocomplete="off"  action="{{ route('bookings.store') }}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="row">
                        <div class="col-md-12 ">
                           ...
                           <input class="form-control" placeholder="yyyy/mm/dd" type="date" name="tgl_check_in"> 
                        </div>
                        <div class="col-md-12 ">
                            <strong>Tanggal Check Out</strong>
                           <input class="form-control" placeholder="yyyy/mm/dd" type="date" name="tgl_check_out"> 
                        </div>
                        <div class="col-md-12 ">
                            <strong>Nama Pemesan</strong>
                           <input class="form-control" placeholder="Nama Pemesan" type="text" name="nama_pemesan"> 
                        </div>
                        <div class="col-md-12 ">
                            <strong>Nama Tamu</strong>
                           <input class="form-control" placeholder="Nama Tamu" type="text" name="nama_tamu"> 
                        </div>
                        <div class="col-md-12">
                            <strong>Email</strong>
                        ...
                        <div class="col-md-12">
                           ...
                           <input class="form-control" placeholder="Phone Number" type="number" name="no_hp">                      
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12 mb-4">
                           ...
                           <input class="form-control" placeholder="Jumlah Kamar" type="number" name="jumlah">                          
                        </div>
                        <div class="d-grid gap-2 col-6 mx-auto">
                           <button class="send_btn btn btn-primary">Konfirmasi Pesanan</button>
                        </div>
                     </div>
                  </form>
               </div>
