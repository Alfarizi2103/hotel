...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="ui/img/breakfast.jpeg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="ui/img/hotel.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="ui/img/makananasia.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="ui/img/hotel.jpg" class="img-fluid" alt="">
          </div>
